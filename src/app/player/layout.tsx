  ...
  return (
    <div className="flex-1 flex flex-col max-w-lg w-full mx-auto pb-24">
      ...
      <nav className="fixed bottom-0 inset-x-0 bg-surface-1/95 backdrop-blur border-t border-white/10">
        <div className="max-w-lg mx-auto grid grid-cols-5 text-center text-[11px]">
          ...
          <Link href="/player/strength" className="py-3 text-ink-2 hover:text-ink">
            <span className="block text-lg leading-none mb-0.5">💪</span>筋トレ
          </Link>
